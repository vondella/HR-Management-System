...
{
    public class LeaveApplicationListModel : PageModel
    {
        private readonly HRMS_DB_Context _db;

        private readonly AccountManageModel _accountManage;

        public LeaveApplicationListModel(HRMS_DB_Context db, AccountManageModel accountManage)
        {
            _db = db;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                LeaveApplications = await _db.LeaveApplications.Include(a => a.LeaveCategory).Include(a => a.User).ToListAsync();
            }
