...
{
    public class ManageSalaryDetailsModel : PageModel
    {
        private readonly HRMS_DB_Context _db;

        private readonly AccountManageModel _accountManage;

        public ManageSalaryDetailsModel(HRMS_DB_Context db, AccountManageModel accountManage)
        {
            _db = db;
        ...
        public IActionResult OnGet(string src_string)
        {
            ...
            Employees = _db.Users.Where(a => a.UserType == UserType.Employee && a.Status == true).ToList();
